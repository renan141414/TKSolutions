...
def criar_banco_clientes(cliente, num_clientes=50):
    ...
    colecao_clientes.drop()  # Limpar coleção existente
    ...
    cidades = ['São Paulo', 'Rio de Janeiro', 'Belo Horizonte', 'Salvador', 'Brasília', 'Curitiba', 'Porto Alegre', 'Recife', 'Fortaleza', 'Manaus']
